...
with Client("elricxbot", api_id=API_ID, api_hash=API_HASH) as app:
  app.send_message("me", f"This Is Your DeadlyUserbot • [ `SESSION` ]\n\n```{app.export_session_string()}```\n\n⚠️• Don't share this with anyone !!\n\nCreate session online • [ Press Here](https://replit.com/@elric-xd/DeadlyUserbot-Session)", disable_web_page_preview=True) 
